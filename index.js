...
const { sessionName, session, autobio, port, mycode, antiforeign, packname,  } = require("./settings.js");
...
const sessdata = session.replace("404-XMD;;;", '');
...
startRaven()
      ...
      console.log(color("Congrats, 404-XMD has successfully connected to this server", "green"));
      console.log(color("Follow me on github as 404unkown", "red"));
